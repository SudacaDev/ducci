...
import type { Momento, MomentoCategoria, MomentoInsert, MomentoUpdate } from '@/types/momentos';
...
export function useMomentos(initialCategoria: MomentoCategoria = 'todos') {
  ...
  const [categoria, setCategoria] = useState<MomentoCategoria>(initialCategoria);
