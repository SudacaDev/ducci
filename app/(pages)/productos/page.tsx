...
export const metadata: Metadata = {
  ...
  description:
    "Dusfruta Ducci: helados artesanales premium. Baldes de 1L, 3L y 5L, alfajores helados artesanales y productos gourmet. Pedí online con envío a domicilio.",
  keywords: [
    "productos",
    "helados ducci",
    "helados artesanales",
  ...
  openGraph: {
    ...
    description:
      "Baldes de helado, alfajores helados y productos premium. Pedí online con envío a domicilio.",
  ...
  twitter: {
    ...
    description:
      "Baldes de helado, alfajores helados artesanales. Pedí online.",
  },
};
