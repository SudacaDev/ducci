...
export const metadata: Metadata = {
  ...
  description: "Ducci Gelateria: helados artesanales premium en Argentina. El punto de encuentro perfecto para compartir momentos únicos. Baldes, alfajores helados y más con delivery.",
  keywords: [
    "Ducci",
    "ducci gelateria",
    "dusfruta ducci",
  ...
  openGraph: {
    ...
    description: "Ducci es mucho más que una heladería. Es el punto de encuentro perfecto para compartir momentos únicos.",
    type: "website",
    locale: "es_AR",
