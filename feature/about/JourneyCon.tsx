          ...
          <Block>
            ...
            <Block.Body ref={refBodyCopy}>
              <div className="flex flex-col about-section__text">
                <p>
                  {" "}
                  Nuestra propuesta combina tradición, técnica y creatividad
                  para ofrecer sabores de calidad en cada cucharada. Trabajamos
                  con procesos cuidados, elaboración diaria y una selección
                  rigurosa de ingredientes. Eso nos permite mantener un estilo
                  propio y garantizar un producto estable, noble y siempre
                  fresco.
                </p>
                <p>
                  {" "}
                  En Ducci entendemos el helado como una experiencia. Por eso
                  buscamos mejorar constantemente, crear nuevas combinaciones y
                  ofrecer un servicio cercano. Cada pote, cada bocha y cada
                  presentación reflejan lo que nos define: calidad, dedicación y
          ...
          <Block>
            ...
            <Block.Body ref={refBodyCopy}>
              <div className="flex flex-col about-section__text">
                <p>
                  {" "}
                  Momentos Ducci es nuestra forma de celebrar esos instantes que
                  se vuelven especiales cuando el helado acompaña. Copas únicas,
                  sabores distintivos y combinaciones pensadas para compartir,
                  sorprender y disfrutar.
                </p>
                <p>
                  {" "}
                  Porque en Ducci el helado no es solo un producto: es parte de
                  encuentros, pausas y momentos para darse un gusto. Creamos
                  propuestas para que cada ocasión tenga su sabor inolvidable.
                </p>
              </div>
            </Block.Body>
            <Block.Footer ref={refButtonCTA}>
